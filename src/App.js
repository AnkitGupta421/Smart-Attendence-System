...
// The issue was here: The library name for Google OAuth was incorrect.
// I have removed the import statement since the Google OAuth library is being
// used through the `signInWithPopup` method from Firebase, which handles
// the authentication flow internally. This simplifies the code and resolves the
